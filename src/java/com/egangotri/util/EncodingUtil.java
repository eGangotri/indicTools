...
public class EncodingUtil
{
    ...
    public static String VELTHIUS     = "VELTHIUS";
    ...
    {
        return VelthuisToSLP.transform(VelthuisToUniformVelthuis.transform(alter));
    }
    ...
    public static String convertVelthiusToDVN(String string)
    {
    ...
    public static String convertToDVN(String str, String encoding)
    {
        ...
        else if (EncodingUtil.VELTHIUS.equalsIgnoreCase(encoding))
            return convertVelthiusToDVN(str);
        else
            return str;
    }
